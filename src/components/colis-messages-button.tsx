  ...
  return (
    <>
      ...
      >
        ...
        {!!count && count > 0 && (
          <span className="absolute -end-1.5 -top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[10px] font-black text-white">
            {count}
          </span>
        )}
      </button>
            ...
            >
              <div className="flex items-center justify-between gap-3 border-b border-border px-5 py-4">
                <div className="flex min-w-0 items-center gap-2">
                  <h2 className="shrink-0 font-bold">{t("cmb.messages")}</h2>
              ...
              {isStaff ? (
                <div className="flex gap-1 border-b border-border px-5 pt-3">
                  ...
                  >
                    <MessageCircle className="me-1.5 inline h-4 w-4" /> {t("chm.tab.comments")}
                  </button>
                  <button
                  ...
                  >
                    <MessageSquare className="me-1.5 inline h-4 w-4" /> {t("chm.tab.notes")}
                  </button>
                </div>
              ) : null}
